module sine_rom(
    input [7:0]address, //  [0-255], angle = 2pi*[0-255]/256
    output reg [7:0]amplitude //amplitude of sine wave [0-255]
);
...
always @(*) begin
    ...
    8'd11: amplitude = 8'd161;
    8'd12: amplitude = 8'd164;
    ...
    8'd116: amplitude = 8'd164;
    8'd117: amplitude = 8'd161;
    ...
    8'd139: amplitude = 8'd94;
    8'd140: amplitude = 8'd91;
    ...
    8'd244: amplitude = 8'd91;
    8'd245: amplitude = 8'd94;
